...
void fragment()
{
	...
	COLOR.r = texture(SCREEN_TEXTURE, SCREEN_UV+UV*SCREEN_PIXEL_SIZE - dispR).r;
	COLOR.g = texture(SCREEN_TEXTURE, SCREEN_UV+UV*SCREEN_PIXEL_SIZE - dispG).g;
	COLOR.b = texture(SCREEN_TEXTURE, SCREEN_UV+UV*SCREEN_PIXEL_SIZE+ - dispB).b;
	//COLOR.rgb =  vec3(mask);
}
void light()
{
